...
We'll now use this model to create some predictions on our training and testing dataset. First, we can take a look at the first ten predictions in our training dataset based on our fitted model:  
```{r}
...
In order to do this, we'll continue to use the `MASS` package:  
